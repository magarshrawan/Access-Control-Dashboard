...
from app.models.userModel import get_all_users, get_user_by_id, get_user_by_username, create_user, update_user, deactivate_user
...
def create_user_ctrl(form, actor_id, ip_address):
    ...
    try:
        ...
        log_action(actor_id, 'USER_CREATED', resource_type='user', resource_id=new_id, ip_address=ip_address)
...
def update_user_ctrl(user_id, form, actor_id, ip_address):
    ...
    try:
        ...
        log_action(actor_id, 'USER_UPDATED', resource_type='user', resource_id=user_id, ip_address=ip_address)
...
def deactivate_user_ctrl(user_id, actor_id, ip_address):
    try:
        ...
        log_action(actor_id, 'USER_DEACTIVATED', resource_type='user', resource_id=user_id, ip_address=ip_address)
